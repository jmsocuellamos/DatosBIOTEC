...
aov_03.csv       |  Table 6.18 shows plasma inorganic phosphate levels (mg/dl) one hour after a standard glucose tolerance test for obese subjects, with or without hyperinsulinemia, and controls  (Table 6.18 Dobson).
...
# aov_03
aov_03=read_csv("https://goo.gl/3L4EtK", col_types = "dd")
```
