...
str(ancov_05)
# Recodificación del factor
ancov_05 %>% mutate(extras1=fct_recode(extras1,"ABS yes"="1","ABS no"="2"),extras2=fct_recode(extras2,"sunroof yes"="1","sunroof no"="2"))
```
