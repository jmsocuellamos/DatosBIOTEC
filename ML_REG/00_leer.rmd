...
ml_reg_03.csv       |   Data shows the average apparent per capita consumption ofsuga r (in kg per year) in Australia, as refined sugar and in manufactured foods (from Australian Bureau ofStatistics, 1998). (Table 6.6 Dobson).
...
str(ml_reg_02)
# ml_reg_03
ml_reg_03=read_csv("https://goo.gl/gRThLb", col_types = "cdd")
str(ml_reg_03)
```
