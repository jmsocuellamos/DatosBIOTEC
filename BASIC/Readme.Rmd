...
LSADATA | Data refer to the cserum lipid-bound sialic data. We wish to conduct a study to determine if the measurements of serum might be of use in the detection of breast cancer. The measurements are for five populations of subjects: A (Control), B (patients with benign breast disease), C (patients with primary breast cancer), D (patients with recurrent metastasic breast cancer) (pag 403, Daniel)
