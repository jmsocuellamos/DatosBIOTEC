...
### leemos las dos varaibles como double para poder obtener la tabla de respuestas binomilaes (éxitos (y=con sintomas) , casos totales(n))para cada valor de score 
str(glm_bin_03)
# Recodificación del factor
glm_bin_03 %>% mutate(senility=fct_recode(senility,"Symptoms" = "1","No Symptoms" = "0"))
```
