...
# glm_bin_07
glm_bin_07=read_csv("https://hec.su/goEN", col_types = "cccddcc")
str(glm_bin_07)
# Recodificación de factores 
glm_bin_07 %>% mutate(acc1=fct_recode(acc1,"no running account" = "1","good or bad running account" = "0"),acc2=fct_recode(acc2,"good running account" = "1","no or bad running account" = "0"),moral=fct_recode(moral,"good" = "1","bad" = "0"),intuse=fct_recode(intuse,"private" = "1","business" = "0")) 

# glm_bin_08
glm_bin_08=read_csv("https://hec.su/goEN", col_types = "dcccciddd")
str(glm_bin_08)
# Recodificación de factores 
glm_bin_08 %>% mutate(acc1=fct_recode(acc1,"no running account" = "1","good or bad running account" = "0"),acc2=fct_recode(acc2,"good running account" = "1","no or bad running account" = "0"),moral=fct_recode(moral,"good" = "1","bad" = "0"),intuse=fct_recode(intuse,"private" = "1","business" = "0")) 
```
